...
import { mockCompanyDetails, mockStockQuote, companyNews, Title } from "../constants/mock";
import Details from "./Details";
import Overview from "./Overview";
import Chart from "./Chart";
import StockContext from "../context/StockContext";
import { fetchQuote, fetchStockDetails, fetchCompanyinfo } from "../api/stock-api";
...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    const updateStockDetails = async () => {
      try {
        const result = await fetchCompanyinfo(stockSymbol);
